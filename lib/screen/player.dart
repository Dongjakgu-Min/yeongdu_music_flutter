          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() {
                ...
                return Slider(
                  min: 0.0,
                  max: seekController.duration.value == null ? 1.0 : seekController.duration.value!.inMilliseconds.toDouble(),
                  onChanged: (double value) {
                    seekController.setDragValue(value);
                    log(seekController.dragValue.toString());
                  },
                  onChangeEnd: (double value) {
                    _player.audioPlayer.seek(Duration(milliseconds: value.toInt()));
                    seekController.removeDragValue();
                    log(seekController.dragValue.toString());
                  },
                  value: seekController.dragValue.value ?? seekController.position.value.inMilliseconds.toDouble(),
                );
              }),
